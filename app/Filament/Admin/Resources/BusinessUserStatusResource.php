<?php
// app/Filament/Admin/Resources/BusinessUserStatusResource.php

namespace App\Filament\Admin\Resources;

use App\Filament\Admin\Resources\BusinessUserStatusResource\Pages;
...
class BusinessUserStatusResource extends Resource
{
    protected static ?string $model = BusinessUserStatus::class;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Section::make('Business User Status Information')
                    ->schema([
                        Grid::make(2)
                            ->schema([
                                TextInput::make('name')
    ...
    {
        return [
            'index' => Pages\ListBusinessUserStatuses::route('/'),
            'create' => Pages\CreateBusinessUserStatus::route('/create'),
            'edit' => Pages\EditBusinessUserStatus::route('/{record}/edit'),
        ];
    }
}
